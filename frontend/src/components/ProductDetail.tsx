    ...
    <div className="max-w-7xl mx-auto px-6 py-10">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
        <div className="sticky top-24 flex flex-col gap-5">
          ...
          {product.source && (
            <div className="inline-flex items-center gap-2 px-4 py-2 bg-white/60 backdrop-blur-md rounded-xl text-gray-600 font-medium text-sm border border-white/20 shadow-sm w-fit">
